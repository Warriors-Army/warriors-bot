module.exports = (client, msg) => {
  if (msg.author.bot) return; //si c'est un bot qui parle, on s'en occupe pas
  if (msg.content.indexOf(client.PREFIX) !== 0) return; //si le message ne commence pas par le prefix, on s'en occupe pas
